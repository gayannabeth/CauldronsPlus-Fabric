...
public class CauldronsBlockStatesModelGen extends FabricModelProvider {
	...
	public void generateBlockStateModels(BlockStateModelGenerator gen) {
		...
		CauldronsBlockStates.registerFourLeveledCauldron(gen, CauldronsBlocks.MILK_CAULDRON, AquiferTextureMaps.cauldron(TextureMap.getId(Blocks.CAULDRON), MilkCauldronBlock.MILK_TEXTURE_ID));
