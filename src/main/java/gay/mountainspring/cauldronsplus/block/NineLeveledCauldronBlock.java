...
public abstract class NineLeveledCauldronBlock extends AquiferLeveledCauldronBlock {
	public static final IntProperty LEVEL = CauldronsBlocks.LEVEL_9;
	
	public NineLeveledCauldronBlock(Biome.Precipitation precipitation, CauldronGroup group, Settings settings, CauldronBehaviorMap behaviorMap) {
