...
public class CauldronBlockEntityTypes {
	...
	public static final BlockEntityType<DyedWaterCauldronBlockEntity> DYED_WATER_CAULDRON = register("dyed_water_cauldron", BlockEntityType.Builder.create(DyedWaterCauldronBlockEntity::new));
	public static final BlockEntityType<PotionCauldronBlockEntity> POTION_CAULDRON = register("potion_cauldron", BlockEntityType.Builder.create(PotionCauldronBlockEntity::new));
