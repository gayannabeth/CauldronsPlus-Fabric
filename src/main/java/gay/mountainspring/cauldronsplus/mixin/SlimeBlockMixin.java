...
public class SlimeBlockMixin implements InjectableFluidDrainable {
	@Override
	public ItemStack tryDrainFluid(PlayerEntity player, WorldAccess world, BlockPos pos, BlockState state) {
		...
		return new ItemStack(CauldronsItems.SLIME_BUCKET);
	}
	
	@Override
	public Optional<SoundEvent> getBucketFillSound() {
		return Optional.of(SoundEvents.BLOCK_SLIME_BLOCK_BREAK);
	}
}